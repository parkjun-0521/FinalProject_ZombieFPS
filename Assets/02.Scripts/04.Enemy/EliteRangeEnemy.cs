...
public class EliteRnageEnemy : EnemyController
{
    ...
    void RPCEnemyRangeAttack()
    {
        ...
        GameObject zombieRangeAtkPrefab = PhotonNetwork.Instantiate("리소스폴더에있는프리팹이름", attackPos.position, Quaternion.identity);
